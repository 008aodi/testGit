...
<div id="head_wrapper" class="s-isindex-wrap head_wrapper s-title-img ">
    <div id="s_fm" class="s_form">
        <div class="s_form_wrapper" id="s_form_wrapper">
            ...
            <form id="form" action="${pageContext.request.contextPath}/product/query">
                <select name="type">
                    <option selected  class="s_ipt" >请选择搜索条件</option>
                    <option value="name"  class="s_ipt">名字</option>
                    <option value="context"  class="s_ipt">内容</option>
                    <option value="price"  class="s_ipt">价格</option>
                    <option value="produce"  class="s_ipt">产地</option>
                </select><br/>
