...
public class RSAUtil {
    ...
    public void test2() throws Exception {
        ...
        param.put("zhangpeng","123456789");
        String string = JSONObject.toJSONString(param);
        //
        // 公钥加密
        String encryptedBytes = encryptByPublicKey(string);
        ...
        // 私钥加密
        String encryptedBytes2 = encryptByPrivateKey(string);
